...
public class RequestHeaderServlet extends HttpServlet {
    ...
    //Header comfortable retrieve
    private void printHeaderUtils(HttpServletRequest request) {
        System.out.println("--- Header Convenient Lookup Start ---");
        System.out.println("[Host Lookup]");
        ...
        System.out.println();
        System.out.println("[Accept-Language Lookup]");
        request.getLocales().asIterator()
                .forEachRemaining(locale -> System.out.println("locale = " + locale));
        System.out.println("request.getLocale() = " + request.getLocale());
        System.out.println();
        System.out.println("[Cookie Lookup]");
        ...
        System.out.println();
        System.out.println("[Content Lookup]");
        System.out.println("request.getContentType() = " + request.getContentType());
        System.out.println("request.getContentLength() = " + request.getContentLength());
        System.out.println("request.getCharacterEncoding() = " + request.getCharacterEncoding());
        System.out.println("--- Header Convenient Lookup End ---");
        System.out.println();
    }
