...
public class ApplicationContextExtendsFindTest {
    ...
    @Test
    @DisplayName("Throws error when multiple child beans exist for parent type")
...
//          DiscountPolicy bean = ac.getBean(DiscountPolicy.class);
    ...
    @Test
    @DisplayName("Find bean by name when multiple child beans exist for parent type")
    ...
    @Test
    @DisplayName("Find bean by specific subtype")
