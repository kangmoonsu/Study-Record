...
import kr.co.moon.restfulservice.dao.UserDaoService;
...
public class UserController {
    ...
    /*
        {
            "id": 1,
            "name": "Kenneth",
            "joinDate": "2024-03-15T05:18:49.370+00:00",
            "_links": {
                "all-users": {
    ...
    */
    ...
    @ApiResponses({@ApiResponse(responseCode = "200", description = "OK"), @ApiResponse(responseCode = "400", description = "BAD REQUEST"), @ApiResponse(responseCode = "404", description = "USER NOT FOUND"), @ApiResponse(responseCode = "500", description = "INTERNAL SERVER ERROR"),})
    @GetMapping("/users/{id}")
